...
public class TesteVeiculo {
	...
	public static void main(String[] args) {
		...
		objeto.preecherMontadora(JOptionPane.showInputDialog("Montadora"));
		objeto.preecherValor(Float.parseFloat(JOptionPane.showInputDialog("Valor")));
		//3º Exibir os dados
		...
		objeto2.preecherTudo(20000, "UNO", "FIAT");
